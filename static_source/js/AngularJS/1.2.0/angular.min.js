...
(function (W, O, s) {
	...
	function da(b, a) {
		...
		if (a) {
			if (b ===
				a) throw Ma("cpi");
			if (J(b))
				for (var c = a.length = 0; c < b.length; c++) a.push(da(b[c]));
			else {
				c = a.$$hashKey;
				q(a, function (b, c) {
					delete a[c]
	...
	function Aa(b, a) {
		...
		if (c == typeof a &&
			...
			if (J(b)) {
				...
				for (d in a)
					if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== s && !B(a[d])) return !1;
				return !0
			}
		return !1
	}
			...
			if (!d || null != b)
				for (; e.length;)
					for (k = e.shift(), l = 0, n = k.length; l < n; l++)
						for (r = y(k[l]), m ? r.triggerHandler("$destroy") : m = !m, p = 0, r = (C = r.children()).length; p < r; p++) e.push(Ba(C[p]));
			return f.apply(this,
				arguments)
		}
		var f = Ba.fn[b],
	...
	function ja(b, a, c) {
		var d = b[db],
			d = Ra[d || -1];
		if (z(c)) d || (b[db] = d = ++Tc, d = Ra[d] = {}), d[a] = c;
		else return d && d[a]
	}
		...
		function e(a) {
			...
			q(a, function (a) {
				if (!k.get(a)) {
					...
					try {
						if (D(a))
							for (c = Ua(a), b = b.concat(e(c.requires)).concat(c._runBlocks), d = c._invokeQueue,
...
[],
	...
	function $c(b, a, c, d) {
		...
		h.cookies = function (a, b) {
			var d, e, f, h;
			if (a) b === s ? m.cookie = escape(a) + "=;path=" + va + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : D(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + va).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
			else {
				if (m.cookie !== $)
					for ($ = m.cookie, d = $.split("; "), oa = {}, f = 0; f < d.length; f++) e = d[f], h = e.indexOf("="), 0 < h && (a =
	...
	function ec(b) {
		...
		this.directive = function k(d, e) {
			na(d, "directive");
			D(d) ? (tb(e, "directiveFactory"), a.hasOwnProperty(d) || (a[d] = [], b.factory(d + c, ["$injector", "$exceptionHandler",
				function (b, c) {
					var e = [];
					q(a[d], function (a, f) {
						try {
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate",
			function (b, l, n, r, p, C, H, I, A, S, G) {
				...
				function oa(a, b, c, f, h) {
					...
					case 1:
						...
						a = a.className;
						if (D(a) && "" !== a)
							for (; k = e.exec(a);) p = ka(k[2]), N(b, p, "C", f, h) && (c[p] = Y(k[3])), a = a.substr(k.index + k[0].length);
						break;
					case 3:
						t(b, a.nodeValue);
						break;
				...
				function M(a, b, c, d, e, f, h, k, g) {
					...
					var E = -Number.MAX_VALUE,
						I, A = g.controllerDirectives,
						G = g.newIsolateScopeDirective,
						N = g.templateDirective;
					...
					for (var M = c.$$element = y(b), F, ba, t, wa = d, x, ga = 0, w = a.length; ga < w; ga++) {
						...
						if (t = F.transclude) F.$$tlb || (Va("transclusion", g, F, M), g = F), "element" == t ? (E = F.priority, t = $(b, u, Fa), M = c.$$element = y(O.createComment(" " + ba + ": " + c[ba] + " ")), b = M[0], L(e, y(ta.call(t,
							0)), b), wa = v(t, d, E, f && f.name, {
							transcludeDirective: g
						})) : (t = y(zb(b)).contents(), M.html(""), wa = v(t, d));
						if (F.template)
							if (Va("template", N, F, M), N = F, t = B(F.template) ? F.template(M, c) : F.template, t = fc(t), F.replace) {
								f = F;
				...
				function ad(a, b, c, d, e, f, h, g) {
					...
					b.html("");
					r.get(S.getTrustedResourceUrl(I), {
						cache: p
					}).success(function (p) {
						var r;
						p = fc(p);
					...
					$set: function (a, b, c, d) {
						...
						if ("class" == a) b = b || "", c = this.$$element.attr("class") || "", this.$removeClass(e(c, b).join(" ")), this.$addClass(e(b, c).join(" "));
							...
							if ("A" === h && "href" === a || "IMG" === h && "src" === a)
								if (!P || 8 <= P) h = xa(b).href, "" !== h && ("href" === a && !h.match(f) || "src" === a && !h.match(g)) && (this[a] = b = "unsafe:" +
				...
				var ba = l.startSymbol(),
					ga = l.endSymbol(),
					fc = "{{" == ba || "}}" == ga ? za : function (a) {
			...
			function (a, b, c, d, n, r) {
				function p(a) {
					function c(a) {
						var b =
							u({}, a, {
								data: ic(a.data, a.headers, d.transformResponse)
							});
...
"$sce",
	...
	function Hb(b, a) {
		...
		this.$$parse = function (d) {
			var e = la(b, d) || la(c, d),
				e = "#" == e.charAt(0) ? la(a, e) : this.$$html5 ? e : "";
		...
		this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser",
			function (c, d, e, f) {
				...
				g.prototype = {
					constructor: g,
					$new: function (a) {
						a ? (a = new g, a.$root = this.$root, a.$$asyncQueue = this.$$asyncQueue, a.$$postDigestQueue = this.$$postDigestQueue) : (a = function () {}, a.prototype = this, a = new a, a.$id = Za());
						a["this"] = a;
						a.$$listeners = {};
						a.$parent = this;
						...
						do {
							...
							do {
								...
								if (!(g = v.$$childHead || v !== this &&
									v.$$nextSibling))
									for (; v !== this && !(g = v.$$nextSibling);) v = v.$parent
							} while (v = g);
					...
					$emit: function (a, b) {
						var c = [],
							...
							g = {
								...
								defaultPrevented: !1
							}, k = [g].concat(ta.call(arguments, 1)),
							l, m;
						do {
							e = f.$$listeners[a] || c;
							g.currentScope = f;
				...
				return {
					...
					getTrusted: function (c, d) {
						...
						if (c === ca.RESOURCE_URL) {
							...
							for (h =
								b.length; f < h; f++)
								if ("self" === b[f] ? Eb(e) : b[f].exec(e.href)) {
									q = !0;
									break
								}
							if (q)
								for (f = 0, h = a.length; f < h; f++)
									if ("self" === a[f] ? Eb(e) : a[f].exec(e.href)) {
										q = !1;
										break
									}
							if (q) return d;
	...
	function Ad() {
		this.$get = ["$window", "$document",
			function (b, a) {
				var c = {}, d = U((/android (\d+)/.exec(w((b.navigator || {}).userAgent)) || [])[1]),
					e = /Boxee/i.test((b.navigator || {}).userAgent),
					f = a[0] || {}, g, h = /^(Moz|webkit|O|ms)(?=[A-Z])/,
	...
	function Ac(b, a, c, d, e) {
		...
		if (k) 0 < e && (-1 < b && 1 > b) && (h = b.toFixed(e));
			...
			var l = 0,
				...
				r = a.gSize;
			if (g.length >= n + r)
				for (l = g.length - n, k = 0; k < l; k++) 0 === (l - k) % r && 0 !==
					k && (h += c), h += g.charAt(k);
	...
	function Cc(b, a) {
		...
		d.$setValidity = function (a, b, h) {
			var n = g[a];
			if (b) n && (La(n, h), n.length || (f--, f || (c(b), d.$valid = !0, d.$invalid = !1), g[a] = !1, c(!0, a), e.$setValidity(a, !0, d)));
			else {
				f || c(b);
				if (n) {
					if (-1 != ab(n, h)) return
	...
	var Pc = /[A-Z]/g,
		...
		}, Ra = Q.cache = {}, db = Q.expando = "ng-" + (new Date).getTime(),
		Tc = 1,
		Dc = W.document.addEventListener ? function (b, a, c) {
		...
		readString: function (a) {
			...
			for (var d = "", e = a, f = !1; this.index < this.text.length;) {
				...
				if (f) "u" === g ? (g = this.text.substring(this.index + 1, this.index + 5), g.match(/[\da-f]{4}/i) ||
					this.throwError("Invalid unicode escape [\\u" + g + "]"), this.index += 4, d += String.fromCharCode(parseInt(g, 16))) : d = (f = Qd[g]) ? d + f : d + g, f = !1;
				else if ("\\" === g) f = !0;
				else {
					if (g === a) {
						this.index++;
...
[], m = c ? c(f, g) : f, k = 0; k < d.length; k++) h.push(d[k](f, g));
	...
	var Bc =
		...
		}, Jd = /((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/,
		Id = /^\-?\d+$/;
	xc.$inject = ["$locale"];
	var Gd = aa(w),
		Hd = aa(Ga);
	...
	var Ec = function (a) {
		...
		Vd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/,
		Wd =
			/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
		Fc = {
			text: ob,
		...
		Ha = "ng-pristine",
		nb = "ng-dirty",
		Xd = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse",
			function (a, c, d, e, f) {
				function g(a, c) {
					c = c ? "-" + cb(c, "-") : "";
				...
				return {
					...
					compile: function (e, f, g) {
						return function (e, f, k) {
							var l = k.ngRepeat,
								n = l.match(/^\s*(.+)\s+in\s+(.*?)\s*(\s+track\s+by\s+(.+)\s*)?$/),
								r, p, s, t, z, A, x, G = {
									$id: Ca
								};
							if (!n) throw d("iexp", l);
							...
							e.$watchCollection(z, function (a) {
								...
								for (k = 0; k < n; k++)
									if (w = a === D ? k :
										D[k], I = a[w], I = z(w, I, k), na(I, "`track by` id"), v.hasOwnProperty(I)) u = v[I], delete v[I], M[I] = u, J[k] = u;
									else {
					...
					link: function (e, g, h, m) {
						...
						function n(e, f, g) {
							function h() {
								...
								if (t)
									if (v && J(u))
										for (s = new Sa([]), B = 0; B < u.length; B++) K[m] = u[B], s.put(v(e, K), u[B]);
									else s = new Sa(u);
									...
									e.$apply(function () {
										...
										if (t)
											for (k = [], p = 0, x = y.length; p < x; p++)
												for (a = y[p], l = 1, u = a.length; l < u; l++) {
													if ((h = a[l].element)[0].selected) {
														h = h.val();
														n && (d[n] = h);
														if (v)
															for (w = 0; w < c.length && (d[m] = c[w], v(e, d) != h); w++);
														else d[m] = c[h];
														k.push(q(e, d))
													}
						...
						if (m[1]) {
							var r = m[0],
								...
								u = h.ngOptions,
								w = !1,
								A, D = y(O.createElement("option")),
								G = y(O.createElement("optgroup")),
								v = D.clone();
							m = 0;
							for (var B = g.children(), E = B.length; m < E; m++)
								if ("" === B[m].value) {
									A = w = B.eq(m);
									break
								}
