...
func init() {
	orm.RegisterDataBase("default", "mysql", "use_different_db_for_testing:password123@/use_different_db_for_testing?charset=utf8", 30)
...
func TestUserVerifyCode(t *testing.T) {
	...
	user.Email = "service@contactlist.com"
	user.Password = encoded
	user.Rands = GetRandomString(10)
	SecretKey = encoded
	ActivationCodeLives = 1
	ResetPwdCodeLives = 1
